 ...
 */
@Generated
public class myapp__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new myapp__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new myapp__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
